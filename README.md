...
- ✅ **多种练习模式**：
  ...
  - 📝 模拟考试（随机 40 题：32 单选 + 8 多选，限时 20 分钟，答对 ≥30 合格）
  - ❌ 错题本（答对移除，专项强化）
...
📥 **[下载 HAM考试 离线版 v1.0.8](https://github.com/bjdr69/ham-exam/releases/download/v1.0.8/HAM-exam-v1.0.8.apk)**
...
>
> **v1.0.7 更新**：**选项顺序全量洗牌**——单选题答案不再恒为 A（分布 A 136 / B 146 / C 142 / D 123），多选题从「AB/ABC/ABCD 连选」打散为 11 种组合。每题正确答案内容不变，答案解释中的选项字母引用已同步改写（A类证书 / D层电离层 / A机 / C波段 / DC收信机 / D-STAR 等 53 处专业语义自动保护）。与 v1.0.5 同签名密钥，**直接覆盖安装，错题本/进度保留**。
>
...
| 特性 | 离线版 v1.0.8（推荐） | 旧版 v1.0.0（TWA） |
|------|----------------------|--------------------|
